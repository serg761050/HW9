...
public class DriverManager {
    ...
    public static void createDriver(String udid, String wda, String deviceName, String platformVersion) throws MalformedURLException {
        AppiumDriver<MobileElement> driver = switch (CONFIGURATION_TYPE) {
            ...
            case ANDROID_CLOUD -> new AndroidDriver<>(new URL("https://oauth-vsv761050-a2ed7:2ab222cb-fbce-4b55-a98c-8b7386469714@ondemand.eu-central-1.saucelabs.com:443/wd/hub"),
                CapabilitiesConfigurator.getAndroidCloudCapabilities(udid, deviceName, platformVersion));
